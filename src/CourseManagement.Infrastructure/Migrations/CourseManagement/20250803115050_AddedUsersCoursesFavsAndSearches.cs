...
{
    /// <inheritdoc />
    public partial class AddedUsersCoursesFavsAndSearches : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    optional_completion = table.Column<int>(type: "int", nullable: false),
                    user_is_course_teacher = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
